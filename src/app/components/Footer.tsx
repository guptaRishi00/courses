...
export default function Footer() {
    return (
        <footer className="relative bg-gradient-to-t from-[#0a0a0f] to-[#12121a] pt-20 pb-8">
            {/* Grid Pattern */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-slate-400 mb-6 max-w-sm">
                            Empowering millions of learners worldwide with world-class courses from industry experts.
                        </p>
                        <div className="flex gap-4">
                            {["twitter", "linkedin", "github", "youtube"].map((social) => (
                                <a
                                    key={social}
                                    href={`#${social}`}
                                    className="w-10 h-10 rounded-full bg-white/5 backdrop-blur-sm border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:bg-indigo-500/20 transition-all"
                                >
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {["Development", "Design", "Business", "Marketing", "Data Science"].map((cat) => (
                                <li key={cat}>
                                    <a href="#" className="text-slate-400 hover:text-white transition-colors">
                                        {cat}
                                    </a>
